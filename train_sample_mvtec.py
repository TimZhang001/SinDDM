...
def parse_args():
    ...
    parser.add_argument("--results_folder", help='choose results folder.', default='./results_fov_2/')
    ...
    # diffusion params
    parser.add_argument("--scale_factor", help='downscaling step for each scale.', default=1.411, type=float) # 1.411(sqrt(2)) 1.732(sqrt(3)) 2(sqrt(4)) 4# 
    # training params
    parser.add_argument("--timesteps",        help='total diffusion timesteps.',  default=100, type=int)
    parser.add_argument("--train_batch_size", help='batch size during training.', default=16,  type=int)
    ...
    parser.add_argument("--load_milestone",   help='load specific milestone.', default=18, type=int)
    
    # sampling params
    parser.add_argument("--sample_batch_size", help='batch size during sampling.', default=12, type=int)
    ...
    # device num
    parser.add_argument("--device_num",        help='use specific cuda device.', default=1, type=int)
...
if __name__ == '__main__':
    ...
    if args.mode == 'sample' :
        main()
    elif args.mode == 'train' or args.mode == 'sample_eval': 
        train_sample_all()
